...
export const Formulario = ({ conferencista }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    dependencia: Yup.string()
      .required('Campo obligatorio')
      .max(charLimit, `La dependencia no puede tener más de ${charLimit} caracteres`),
    ciudad: Yup.string()
      .required('Campo obligatorio')
  ...
  return (
    <Formik
      initialValues={{
        ...
        dependencia: conferencista?.dependencia || '',
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <Field
              ...
              maxLength={charLimit}
              className={`border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5 ${
                errors.dependencia && touched.dependencia ? 'border-red-500' : ''
              }`}
            />
            <div className="text-gray-500 text-sm mb-2">
              Caracteres restantes: {charLimit - values.dependencia.length}
            </div>
            <ErrorMessage
              name="dependencia"
              component="div"
