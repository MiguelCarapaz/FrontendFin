...
export const Formulario3 = ({ reserva }) => {
  ...
  const validationSchema = Yup.object().shape({
    codigo: Yup.string()  
      ...
      .max(charLimit, `El codigo no puede tener más de ${charLimit} caracteres`),  
    descripcion: Yup.string()
      .max(charLimit, `La descripción no puede tener más de ${charLimit} caracteres`),
    id_conferencista: Yup.string()
    .required('Campo obligatorio')
    .max(charLimit, `El ID del tecnico no puede tener más de ${charLimit} caracteres`),
    id_auditorio: Yup.string()
      .required('Campo obligatorio')
      .max(charLimit, `El ID del cliente no puede tener más de ${charLimit} caracteres`),
    });
